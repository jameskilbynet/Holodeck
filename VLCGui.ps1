...
      }
	...
	# Set Advanced Setting for EDGE Hugepage Workaround - Tim Sommer
	write-host adding workarounds for EDGE HUGEPAGE Issue - Older Hardware
	 New-AdvancedSetting -Entity $VM_Name -Name monitor_control.enable_fullcpuid -Value TRUE -Confirm:$False -Force:$True
	 New-AdvancedSetting -Entity $VM_Name -Name featMask.vm.cpuid.PDPE1GB -Value Val:1 -Confirm:$False -Force:$True
